...
comptime {
    ...
    if (@import("root") == lib) {
        ...
        @export(&c.render_state_row_cells_get_all, .{ .name = "ghostty_render_state_row_cells_get_all" });
        ...
        @export(&c.terminal_clear_presentation, .{ .name = "ghostty_terminal_clear_presentation" });
        ...
        @export(&c.terminal_snapshot_decoder_push, .{ .name = "ghostty_terminal_snapshot_decoder_push" });
        @export(&c.terminal_snapshot_decoder_take_terminal, .{ .name = "ghostty_terminal_snapshot_decoder_take_terminal" });
        @export(&c.terminal_snapshot_decoder_replay_continuation, .{ .name = "ghostty_terminal_snapshot_decoder_replay_continuation" });
        @export(&c.terminal_snapshot_decoder_abort, .{ .name = "ghostty_terminal_snapshot_decoder_abort" });
        @export(&c.terminal_snapshot_decoder_free, .{ .name = "ghostty_terminal_snapshot_decoder_free" });
        @export(&c.terminal_history_lease_new, .{ .name = "ghostty_terminal_history_lease_new" });
        @export(&c.terminal_history_lease_cursor, .{ .name = "ghostty_terminal_history_lease_cursor" });
        @export(&c.terminal_history_lease_free, .{ .name = "ghostty_terminal_history_lease_free" });
        @export(&c.terminal_history_cursor_next, .{ .name = "ghostty_terminal_history_cursor_next" });
        @export(&c.terminal_history_cursor_free, .{ .name = "ghostty_terminal_history_cursor_free" });
        @export(&c.terminal_history_importer_new, .{ .name = "ghostty_terminal_history_importer_new" });
        @export(&c.terminal_history_importer_push, .{ .name = "ghostty_terminal_history_importer_push" });
        @export(&c.terminal_history_importer_commit, .{ .name = "ghostty_terminal_history_importer_commit" });
        @export(&c.terminal_history_importer_abort, .{ .name = "ghostty_terminal_history_importer_abort" });
        @export(&c.terminal_history_importer_free, .{ .name = "ghostty_terminal_history_importer_free" });
