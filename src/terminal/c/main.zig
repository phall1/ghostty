...
pub const snapshot_incremental = @import("snapshot_incremental.zig");
...
pub const terminal_clear_presentation = terminal.clear_presentation;
...
pub const terminal_snapshot_capabilities = snapshot.capabilities;
pub const terminal_snapshot_encode = snapshot.encode;
pub const terminal_snapshot_decode = snapshot.decode;
pub const terminal_snapshot_incremental_capabilities = snapshot_incremental.capabilities;
pub const terminal_snapshot_capture_new = snapshot_incremental.captureNew;
pub const terminal_snapshot_capture_next = snapshot_incremental.captureNext;
pub const terminal_snapshot_capture_detach_ready = snapshot_incremental.captureDetachReady;
pub const terminal_snapshot_continuation_next = snapshot_incremental.continuationNext;
pub const terminal_snapshot_continuation_abort = snapshot_incremental.continuationAbort;
pub const terminal_snapshot_continuation_free = snapshot_incremental.continuationFree;
pub const terminal_snapshot_capture_abort = snapshot_incremental.captureAbort;
pub const terminal_snapshot_capture_free = snapshot_incremental.captureFree;
pub const terminal_snapshot_decoder_new = snapshot_incremental.decoderNew;
pub const terminal_snapshot_decoder_push = snapshot_incremental.decoderPush;
pub const terminal_snapshot_decoder_take_terminal = snapshot_incremental.decoderTakeTerminal;
pub const terminal_snapshot_decoder_replay_continuation = snapshot_incremental.decoderReplayContinuation;
pub const terminal_snapshot_decoder_abort = snapshot_incremental.decoderAbort;
pub const terminal_snapshot_decoder_free = snapshot_incremental.decoderFree;
pub const terminal_history_lease_new = snapshot_incremental.historyLeaseNew;
pub const terminal_history_lease_cursor = snapshot_incremental.historyLeaseCursor;
pub const terminal_history_lease_free = snapshot_incremental.historyLeaseFree;
pub const terminal_history_cursor_next = snapshot_incremental.historyCursorNext;
pub const terminal_history_cursor_free = snapshot_incremental.historyCursorFree;
pub const terminal_history_importer_new = snapshot_incremental.historyImporterNew;
pub const terminal_history_importer_push = snapshot_incremental.historyImporterPush;
pub const terminal_history_importer_commit = snapshot_incremental.historyImporterCommit;
pub const terminal_history_importer_abort = snapshot_incremental.historyImporterAbort;
pub const terminal_history_importer_free = snapshot_incremental.historyImporterFree;
