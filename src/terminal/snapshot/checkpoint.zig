...
//!
//! READY covers the envelope, TERMINAL, and all SCREEN/PAGE sequences. Version
//! 2 additionally covers its required CONTINUATION record before READY. FINISH
//! covers that version-specific prefix plus the complete READY record and all
//! HISTORY/PAGE sequences. Neither digest includes
